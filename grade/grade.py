...
def main():
    ...
    # call retake procedure, passing in grade_list and average score
...
#def find_ave(grade_list):


# identify the tests that should be retaken
#def find_retake(grade_list, ave):
